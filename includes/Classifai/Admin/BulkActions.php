...
class BulkActions {
	...
	public function bulk_action_admin_notice() {
		if ( empty( $_REQUEST['bulk_classified'] ) ) { //  - Processing form data without nonce verification.
			return;
		}

		$classified_posts_count = intval( $_REQUEST['bulk_classified'] ); //  - Processing form data without nonce verification.
