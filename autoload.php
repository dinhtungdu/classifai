...
class Psr4AutoloaderClass {
	...
	public function load_class( $class ) {
		...
		while ( false !== $pos = strrpos( $prefix, '\\' ) ) { //  - Variable assignment found within a condition. Did you mean to do a comparison?
	...
	protected function require_file( $file ) {
		if ( file_exists( $file ) ) {
			require $file; //  - File inclusion using variable (`$file`). Probably needs manual inspection.
			return true;
		}
		return false;
	}
